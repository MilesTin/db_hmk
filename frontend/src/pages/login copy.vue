    ...
    <div class="main">
      ...
      <el-row type="flex" justify="center">
        <el-col :xs="17" :sm="9" :md="7" :lg="5">
          <el-input placeholder="请输入学号" prefix-icon="el-icon-service" v-model="username" clearable></el-input>
        </el-col>
      </el-row>
      <el-row type="flex" justify="center">
        <el-col :xs="17" :sm="9" :md="7" :lg="5">
      ...
      <el-row type="flex" justify="center">
        <el-col :xs="17" :sm="9" :md="7" :lg="5">
          <el-button type="primary" @click="login()" :disabled="!password || !username">登录</el-button>
        </el-col>
      </el-row>
