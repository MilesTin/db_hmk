...
<div class="main">
  ...
  <div class="box-card">
    <div class="clearfix">
      <!-- <img :src="list.stuId" class="user-head"> -->
      <div class="tao">
        <div class="user-name">{{list.stuId}}</div>
        <div class="time">{{list.publish_time}}</div>
      </div>
      <span class="price">￥{{list.price}}</span>
    </div>
    <div class="title">{{list.name}}</div>
    <div class="description">{{list.description}}</div>
    <div class="images" v-for="(img,index) in list.pics" :key="index">
      <el-image :src="img.pic">
      </el-image>
    </div>
  </div>
  <div class="block"></div>
