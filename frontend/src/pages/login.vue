<template>
  <div class="top">
    <div class="main">
      <span class="title">BOOX</span>
      <el-row type="flex" justify="center">
        <el-col :xs="17" :sm="9" :md="7" :lg="5">
          <el-input placeholder="请输入学号" prefix-icon="el-icon-service" v-model="stuId" clearable></el-input>
        </el-col>
      </el-row>
      <el-row type="flex" justify="center">
        <el-col :xs="17" :sm="9" :md="7" :lg="5">
      ...
      <el-row type="flex" justify="center">
        <el-col :xs="17" :sm="9" :md="7" :lg="5">
          <el-button type="primary" @click="login()" :disabled="!password || !stuId">登录</el-button>
        </el-col>
      </el-row>
...
export default {
  ...
  computed: {
    ...mapGetters(["hasLogin", "errorLogin", "userinfo"])
  },
  created() {
  ...
  methods: {
    ...mapActions(["actionLogin", "actionNotLogin", "actionInitMessagePush"]),
    login: function() {
      this.obj = {
        stuId: this.stuId,
      ...
      this.actionNotLogin();  //设定为未登录
      this.actionLogin(this.obj);  //尝试登录
    }
  },
  watch: {
    hasLogin() {
